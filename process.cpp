...
int main(int argc, char** argv) {
  // Declare two DataLogger objects. One will be used to log all the incoming
  // data. The other will be a way of keeping track of "bad data".
  ...
  while (!inDatafile.eof()) {
    ...
    if (!inDatafile.eof()) {
      ...
      if (((iron < 0) || (silicon < 0)) &&
          !badSectorData.containsSector(sector)) {
